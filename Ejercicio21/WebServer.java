...
public class WebServer {
    ...
    public void startServer() {
        ...
        // Línea que establece la cantidad de hilos en la respuesta del servidor
    ...
    private void handleTaskRequest(HttpExchange exchange) throws IOException {
        ...
        // Imprimir la cantidad de headers recibidos
        System.out.println("Cantidad de headers recibidos: " + headers.size());

        for (String key : headers.keySet()) {
            System.out.println("Header: " + key + " - Valor: " + headers.get(key));
        }
